...
import com.hms.HMS.config.FeignClientInterceptor;
import com.hms.HMS.dto.UserDTO;

@FeignClient(name = "ProfileMS", url = "http://localhost:9100",configuration = FeignClientInterceptor.class)
